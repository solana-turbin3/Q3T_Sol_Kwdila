...
dotnet anchorgen -i target/idl/secret-hitler.json -o target/idl/SecretHitler.cs
```

(Replace secret-hitler with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(SecretHitler_PROGRAM_ID)
      );
    try {
