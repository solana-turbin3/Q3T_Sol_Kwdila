...
import IDL from "../idl/secret-hitler.json";
import { SecretHitler } from "@/idl/secret-hitler";
...
// SecretHitler game program ID
export const PROGRAM_ID = new PublicKey(IDL.address);

export function getProgram(provider: AnchorProvider) {
  return new Program(IDL as SecretHitler, provider);
}
...
export type PlayerData = IdlAccounts<SecretHitler>["playerData"]
export type GameData = IdlAccounts<SecretHitler>["gameData"]
