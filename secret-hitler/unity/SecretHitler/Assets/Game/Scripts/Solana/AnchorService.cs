...
public class AnchorService : MonoBehaviour
{
    ...
    private SecretHitlerClient anchorClient;
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new SecretHitlerClient(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async Task InitAccounts(bool useSession)
    {
        ...
        var initTx = SecretHitlerProgram.InitPlayer(accounts, levelSeed, AnchorProgramIdPubKey);
        tx.Add(initTx);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = SecretHitlerProgram.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
